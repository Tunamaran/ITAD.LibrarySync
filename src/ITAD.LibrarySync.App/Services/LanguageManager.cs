...
public sealed class LanguageManager : INotifyPropertyChanged
{
    ...
    private static string GetEnglishString(string key) => key switch
    {
        ...
        "CloudStatusLookupResultFormat" => "PCGamingWiki lookup finished: {0} save folder(s) found.",
        "CloudNoLookupSelection" => "Select games without a save folder first.",
        ...
        "BtnCloudLookupSelected" => "Look Up on PCGW",
        "BtnCloudLookupSelectedTooltip" => "Runs a PCGamingWiki lookup for the selected games that have no save folder (results are cached).",
    ...
    private static string GetTurkishString(string key) => key switch
    {
        ...
        "CloudStatusLookupResultFormat" => "PCGamingWiki araması tamamlandı: {0} kayıt klasörü bulundu.",
        "CloudNoLookupSelection" => "Önce kayıt klasörü olmayan oyunları seçin.",
        ...
        "BtnCloudLookupSelected" => "PCGW'de Ara",
        "BtnCloudLookupSelectedTooltip" => "Kayıt klasörü olmayan seçili oyunlar için PCGamingWiki araması yapar (sonuçlar önbelleklenir).",
